...
1: Inception Score
2: R precision  
3: Using TSNE to reduce image feature dimensionalities to plot them to compare how close are images generated by GANs to the image output available in test set.
